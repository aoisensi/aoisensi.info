...
これらの5体のヒーローは公式日本語訳が追加された当初から英語のまま放置されています。
...
`__en` が含まれるキーが英語の文字列で、それがない方は日本語の文字列を書くべきところです。

人間なので失敗は誰にでもあります。 そこを責めるつもりはありません。
...
Dota2には日本人人口がほとんどいません。

一緒の試合に日本人がいることはごくごく僅かです。

つまり、コミュニケーションの手段として日本語が使えないことがほとんど確定しているのです。
...
たとえヒーロー名、アイテム名、スキル名であっても、Dota2には一般的な単語がそのままなことが多いです。
...
GitHubでも何度か報告してるんですが解決の兆しは全く無く...
