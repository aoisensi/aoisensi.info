...
REVERIE標準で追加された便利なMODの設定がオプションに追加されているので確認するのをおすすめします。

# チャプター4の導入の注意点

追記です

前回(チャプター3)時点で導入をおすすめしていたセーブスロットを追加するMODの`saveloadplus`が入っていると不具合が起こることがわかりました。

チャプター4のREVERIEにはこのMODが標準で含まれているので、手動で導入しなくてもセーブスロットの追加が可能です。

**チャプター4を遊ぶ前に必ず`saveloadplus`MODを取り除いてください。**
...
- セーブデータは引き継ぎできますか？  
  ...
  REVERIEのチャプター2.5かそれ以降のバージョンのセーブデータなら新しいバージョンでもそのまま続きから始めることができます。  
...
感想はTwitterでハッシュタグ[#omori #reverie](https://twitter.com/search?q=%23omori%20%23reverie)をつけて投稿してください！

# アップデート
2026年03月22日に翻訳の一部を修正したバージョン`4.1.3+jp.3`を公開しました。
